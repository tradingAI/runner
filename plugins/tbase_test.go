...
func TestTbaseGenerateTrainCmds(t *testing.T) {
	...
	runCmd := fmt.Sprintf("python -m trunner.tbase --alg ddpg --eval_result_path %s/evals/0 --max_iter_num 10 --model_dir %smodels --progress_bar_path %sprogress_bars/0 --tensorboard_dir %stensorboards --warm_up 1000",
